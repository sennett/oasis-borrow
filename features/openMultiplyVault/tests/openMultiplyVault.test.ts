...
describe('open multiply vault', () => {
  ...
  describe('openMultiplyVault calculations', () => {
    it('should calculate vault state according spread sheet', () => {
      ...
      expect(stateSnap.buyingCollateral.toPrecision(18)).to.eq('8.82038921170176981')
      expect(stateSnap.afterOutstandingDebt.toPrecision(18)).to.eq('18803.4660922187729')
    })
